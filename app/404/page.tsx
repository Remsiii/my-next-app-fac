    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-[1920px] mx-auto mt-8 p-4">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <Link href="https://www.facebook.com/?locale=de_DE" className="bg-blue-600 text-white text-lg font-semibold px-6 py-3 rounded-md hover:bg-blue-700 transition duration-200">
